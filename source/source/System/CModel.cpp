...
/// 影描画用(本体)
/// </summary>
/// <param name="mtxworld"></param>
/// <param name="_light"></param>
void CModel::DrawModel(XMFLOAT4X4& _mtxworld) {
	...
	//シャドウマップ用シェーダーセット
	ShadowMap::GetInstance().SetShadowShader(devcontext);

	m_assimpfile.Draw(devcontext, _mtxworld);
}

/// <summary>
/// 影描画用（影）
/// </summary>
/// <param name="_mtxworld"></param>
/// <param name="_light"></param>
void CModel::DrawShadow(XMFLOAT4X4& _mtxworld) {
