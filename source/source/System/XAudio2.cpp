...
PARAM g_param[SOUND_LABEL_MAX] =
{
	...
	{"assets/Sound/BGM.wav", true},
	{"assets/Sound/Hit.wav", false},
	{"assets/Sound/exp.wav", false},
	{"assets/Sound/shoot1.wav", false},
};
...
HRESULT InitSound()
{
	...
	for(int i=0; i<SOUND_LABEL_MAX; i++){
		...
		//check the file m_type, should be fourccWAVE or 'XWMA'
